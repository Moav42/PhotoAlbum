...
export class HeaderComponent implements OnInit {
  ...
  openChangePasswordForm(event){
    this.router.navigate(['/user/changePas']).then(success => console.log('navigation success?' , success))
    .catch(console.error); 
  }

  openModeratorPage(event){
    this.router.navigate(['/moderator']).then(success => console.log('navigation success?' , success))
    .catch(console.error); 
  }
}
